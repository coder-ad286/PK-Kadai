      ...
      <section className='bg-[#E1B996] p-5'>
        <div className="container p-1  mx-auto">
          ...
          <div className='font-bold text-center text-[15px] mt-7'>
            ...
            <h5 className='my-3'>தொழில் முனைவோர்கள் நீங்கள் குறைவான ஆரம்பகட்ட  முதலீடு (மூலபொருள்களுக்கு) செய்து.இந்த வசதிகளை கட்டண அடிப்படையில் பயன்படுத்தலாம்.</h5>
            <h5 className='my-3'>பணியாளர்கள் நிலையான நீடித்த வேலை வாய்ப்பினை பெறுவர்..</h5>
          </div>
        </div>
      </section>
